...
/**
 * Get a nested value from an object by a string path
...
/**
 * Load fonts if required and update loaded fonts set
 * @param fonts Array of font names to load
 * @param loadedFonts Set containing currently loaded fonts
 * @returns Updated set of loaded fonts
 */
 ...
 */
export const generateThemeId = (savedThemes: RootStateType["savedThemes"]) => {
